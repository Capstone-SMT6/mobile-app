...
class OnboardingGenderView extends StatefulWidget {
  ...
  @override
  State<OnboardingGenderView> createState() => _OnboardingGenderPageState();
}

class _OnboardingGenderPageState extends State<OnboardingGenderView> {
  final OnboardingController _controller = Get.find<OnboardingController>();
  int? selectedIndex;

  final List<Map<String, dynamic>> genders = [
    {"icon": Icons.man, "text": "Pria", "value": "pria"},
    {"icon": Icons.woman, "text": "Wanita", "value": "wanita"},
  ];

  @override
  void initState() {
    super.initState();
    selectedIndex = genders.indexWhere(
      (gender) => gender["value"] == _controller.gender.value,
    );
                          ...
                          GridView.builder(
                            ...
                            gridDelegate:
                                const SliverGridDelegateWithFixedCrossAxisCount(
                                  ...
                                  mainAxisSpacing: 16,
                                  childAspectRatio:
                                      0.55, // Taller cards for gender selection
                                ),
                      ...
                      onPressed: selectedIndex != null
                          ? () {
                              _controller.gender.value =
                                  genders[selectedIndex!]["value"] as String;
                  ...
                  children: List.generate(9, (index) {
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: index == 1
                            ? Colors.white
                            : Colors.white24, // 2nd dot is active
                      ),
                    );
                  }),
                ),

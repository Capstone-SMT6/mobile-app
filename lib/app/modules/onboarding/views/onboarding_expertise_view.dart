...
class OnboardingExpertiseView extends StatefulWidget {
  const OnboardingExpertiseView({super.key});

  @override
  State<OnboardingExpertiseView> createState() =>
      _OnboardingExpertisePageState();
}

class _OnboardingExpertisePageState extends State<OnboardingExpertiseView> {

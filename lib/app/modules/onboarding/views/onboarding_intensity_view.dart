...
class OnboardingIntensityView extends StatefulWidget {
  const OnboardingIntensityView({super.key});

  @override
  State<OnboardingIntensityView> createState() =>
      _OnboardingIntensityPageState();
}

class _OnboardingIntensityPageState extends State<OnboardingIntensityView> {
  final OnboardingController _controller = Get.find<OnboardingController>();
  String selectedIntensity = '';

  static const Map<String, String> _intensityValues = {
    'Rendah': 'rendah',
    'Sedang': 'sedang',
    'Tinggi': 'tinggi',
  };
  ...
  void initState() {
    super.initState();
    selectedIntensity = _intensityValues.entries
        .firstWhere(
          (entry) => entry.value == _controller.intensity.value,
          orElse: () => const MapEntry('Sedang', 'sedang'),
        )
        .key;
  }
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                ...
                color: isSelected
                    ? const Color(0xFF6CC551).withValues(alpha: 0.8)
                    : Colors.white70,
              ),
            ),
          ],
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: selectedIntensity.isNotEmpty
                          ? () {
                              _controller.intensity.value =
                                  _intensityValues[selectedIntensity]!;
                              _controller.selectedDays.clear();
                              Get.toNamed(AppRoutes.onboardingDays);
                            }
                          : null,
                      style: TextButton.styleFrom(
                        backgroundColor: const Color(0xFF222434),

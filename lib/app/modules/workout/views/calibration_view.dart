...
class CalibrationView extends StatefulWidget {
  ...
  @override
  State<CalibrationView> createState() => _CalibrationPageState();
}

class _CalibrationPageState extends State<CalibrationView> {
  ...
  void _proceedToWorkout() {
    ...
    // Navigate ke workout
    Get.off(() => PoseCameraView(exercise: widget.exercise));
  }

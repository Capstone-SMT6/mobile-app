...
class WorkoutSessionView extends StatefulWidget {
  ...
  const WorkoutSessionView({super.key, required this.workoutPlan});

  @override
  State<WorkoutSessionView> createState() => _WorkoutSessionPageState();
}

class _WorkoutSessionPageState extends State<WorkoutSessionView>
  ...
  void _finishWorkout() {
    ...
    Get.offAll(() => WorkoutSummaryView(data: summary),

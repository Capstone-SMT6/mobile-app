...
class ExerciseListView extends StatelessWidget {
  ...
  static final exercises = [
    ...
    Exercise(
      name: "Jumping Jack",
      gif: "https://media.giphy.com/media/l41JUS4L4b8OtzN6w/giphy.gif",
      desc: "Latihan kardio seluruh tubuh yang sangat baik untuk pemanasan dan meningkatkan detak jantung.",
      muscle: "Full Body, Kardio",
      difficulty: "Pemula",
      target: "3 Set x 20 Reps",
      tips: [
        "Jaga lengan lurus saat di atas kepala",
        "Lompat dengan ringan di ujung kaki",
        "Jaga ritme yang konsisten",
      ],
      mistakes: [
        "Lengan tidak direntangkan penuh",
        "Langkah kaki terlalu sempit",
    ...
    Exercise(
      ...
      desc: "Latihan intensitas tinggi yang melibatkan otot inti sekaligus membakar kalori secara signifikan.",
      muscle: "Inti, Kardio, Kaki",
      difficulty: "Menengah",
      target: "3 Set x 20 Reps",
      tips: [
        "Angkat lutut setinggi pinggul",
        "Gunakan lengan untuk momentum",
        "Jaga tubuh bagian atas tetap tegak",
      ],
      mistakes: [
        "Lutut tidak diangkat cukup tinggi",
        "Badan condong ke belakang",
        "Pendaratan terlalu keras",
      ],
    ),
    Exercise(
      name: "Shoulder Press",
      gif: "https://media.giphy.com/media/1wXcyhQ5t35Ie1zT3m/giphy.gif",
      desc: "Latihan tubuh bagian atas untuk membangun kekuatan bahu dan stabilitas bahu.",
      muscle: "Bahu, Triceps",
      difficulty: "Menengah",
      target: "3 Set x 10 Reps",
      tips: [
        "Dorong tangan hingga lurus di atas kepala",
        "Jaga siku sejajar dengan bahu saat turun",
        "Kencangkan otot inti",
      ],
      mistakes: [
        "Melengkungkan punggung terlalu banyak",
        "Tidak meluruskan siku secara penuh",
        "Menurunkan tangan terlalu rendah",
      ],
    ),
  ];

...
class BerandaPage extends StatelessWidget {
  ...
  Widget _buildMissionSection() {
    ...
    return Padding(
      ...
      child: _isRestDay ? _buildRestDayCard() : _buildWorkoutMissionCard(controller),
    );
  }
  ...
  Widget _buildWorkoutMissionCard(HomeController controller) {
    return Obx(() {
      final calorieProgress = _caloriesBurned / (controller.targetKalori.value > 0 ? controller.targetKalori.value : 1);
      return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text(
        ...
        Row(
          ...
          children: [
            ...
            Text(
              '$_caloriesBurned / ${controller.targetKalori.value} kcal',
        ...
        SizedBox(
          ...
          child: ElevatedButton(
            onPressed: () => Get.toNamed('/poseDetection'),
  ...
  Widget _buildWeightTrendSection() {
    ...
    return Obx(() {
      final String bmiCategory = controller.bmiCategory.value;
      final Color bmiColor = bmiCategory == 'Normal' ? _green : (bmiCategory == 'Kurus' ? Colors.blue : Colors.orange);
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        const Text('Berat Badan', style: TextStyle(color: _textSecondary, fontSize: 11)),
                        const SizedBox(height: 4),
                        Text('${controller.beratBadan.value.toStringAsFixed(1)} kg', style: const TextStyle(color: _textPrimary, fontSize: 18, fontWeight: FontWeight.bold)),
                        Text('Tinggi: ${controller.tinggiBadan.value.toStringAsFixed(0)} cm', style: const TextStyle(color: _textSecondary, fontSize: 11)),
                      ],
                    ),
                  ],
                ),
                ...
                LayoutBuilder(
                  builder: (context, constraints) {
                    final double bmiValue = controller.bmiValue.value;

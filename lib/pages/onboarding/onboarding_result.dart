                ...
                child: Container(
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        _buildResultRow("Tujuan", "Pembentukan Otot"),
                        const Divider(color: Colors.white12, height: 24),
                        _buildResultRow("Gender", "Laki-laki"),
                        const Divider(color: Colors.white12, height: 24),
                        _buildResultRow("Usia", "24 Tahun"),
                        const Divider(color: Colors.white12, height: 24),
                        _buildResultRow("Tinggi / Berat", "175 cm / 70 kg"),
                        const Divider(color: Colors.white12, height: 24),
                        ...
                        const Divider(color: Colors.white12, height: 24),
                        _buildResultRow("Alat", "Dumbbell, Matras"),
